...
- pro pristup do databaze je potreba se dostat do shellu dockeru pomoci: docker -it (interactive - zustava prihlasene i po execute commandu, t - formatuje output at to vyapda jako terminal) simple_api_database_mock_container bash

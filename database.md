...
- Pro vytvoreni modelu: `dotnet ef dbcontext scaffold "Server=localhost,1433;Database=machine_db;User Id=sa;Password=Dochazka123;TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer -o Models --force --namespace SimpleAPI.Models --context-dir Data` viz: dotnet ef dbcontext scaffold --help Dulezite je namespace aby sedelo se zbytkem projektu, context-dir automaticky nastavi kam se ulozi DbContext class
- Pro ukladani citlivych informaci mimo zdrojak: https://learn.microsoft.com/en-us/ef/core/dbcontext-configuration/
- 

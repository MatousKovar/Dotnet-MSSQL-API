...
- Pro vytvoreni modelu: `dotnet ef dbcontext scaffold "Server=localhost,1433;Database=machine_db;User Id=sa;Password=Dochazka123;TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer -o Models --force` viz: dotnet ef dbcontext scaffold --help
- 
